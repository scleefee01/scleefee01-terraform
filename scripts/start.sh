...
envsubst < "${PROJECT_DIR}/manifests/flink-nexmark/nexmark-kafka-sources.template.yaml" | kubectl apply -f -
envsubst < "${PROJECT_DIR}/manifests/flink-nexmark/nexmark-queries.template.yaml" | kubectl apply -f -
...
# Apply start job
envsubst < "${PROJECT_DIR}/manifests/nexmark-kafka/start.template.yaml" | kubectl apply -f -
